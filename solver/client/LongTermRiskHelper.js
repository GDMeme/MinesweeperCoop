...
export class LongTermRiskHelper {
	...
	async findTileInfluence(tile) {
		...
		influence = this.addNotNull(influence, await this.getHorizontal(tile, 4));
		influence = this.addNotNull(influence, await this.getHorizontal(tile1, 4));
		...
		influence4 = this.maxNotNull(influence4, await this.getBoxInfluence(tile, 5));
		influence4 = this.maxNotNull(influence4, await this.getBoxInfluence(tile1, 5));
		influence4 = this.maxNotNull(influence4, await this.getBoxInfluence(tile2, 5));
		influence4 = this.maxNotNull(influence4, await this.getBoxInfluence(tile3, 5));
	...
	async checkFor2Tile5050() {
		...
		for (let i = 0; i < this.board.width - 1; i++) {
			for (let j = 0; j < this.board.height; j++) {
				...
				const result = await this.getHorizontal(tile1, maxMissingMines, this.minesLeft);
		...
		for (let i = 0; i < this.board.width; i++) {
			for (let j = 0; j < this.board.height - 1; j++) {
				...
				const result = await this.getVertical(tile1, maxMissingMines, this.minesLeft);
	...
	async getHorizontal(subject, maxMissingMines) {
	...
	async getVertical(subject, maxMissingMines) {
	...
	async getBoxInfluence(subject, maxMissingMines) {
