...
import { countSolutions, divideBigInt, Action } from "./solver_main.js";
...
export class EfficiencyHelper {
    ...
    async process() {
        ...
        //if (result.length == 0) {
            ...
            const currSolnCount = await countSolutions(this.board);
            ...
            //for (let act of this.coveredTiles) {  // swap this for risky efficiency
                ...
                //if (!act.isSolverFoundBomb()) {   // swap this for risky efficiency
                    ...
                    if (reward > bestChordReward || adjMines == 0) {
                        ...
                        const counter = await countSolutions(this.board);
